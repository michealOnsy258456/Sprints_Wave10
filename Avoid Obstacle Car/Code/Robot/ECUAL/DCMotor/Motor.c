...
PRIVATE MotorSelect_t MOTORS ={	.Motor[MOTOR_1].Pin[MOTOR__H] = GPIO_PIN_2 , .Motor[MOTOR_1].Port[MOTOR__H] = GPIOD ,
...
#if TIM1_IN_USE
PRIVATE TIMInit_t  Tim_PWM_Handler ={ .Instance = TIM1 ,.COMPConfig.TIM16Bit.CompAction = TIM_COMP_PIN_OUT_Normal  , .COMPConfig.TIM16Bit.CompNum = COMP_A_ , .TIM_Interrupt = TIM_1_IT_COMPA ,.TimPreScaler = TIM_1_Prescaler_1  };


#elif TIM2_IN_USE
PRIVATE TIMInit_t  Tim_PWM_Handler ={ .Instance = TIM2 ,.COMPConfig.TIM8Bit.CompAction = TIM_COMP_PIN_OUT_Normal  , .TIM_Interrupt = TIM_2_IT_COMP ,.TimPreScaler = TIM_2_Prescaler_1024 , .COMPConfig.TIM8Bit.CompValue = 0 };
